...
public class Cast{
	...
	/** casts object to string. reads a resource as string when it's a file, url, stream or reader.
	  ...
	  */
	public static String asString(Object o, String defaultEncoding="UTF-8") throws IOException{
		if(o==null){
			return null;
	...
	/** casts object to a BufferedReader. file, url, or stream converts to reader.
	  ...
	  */
	public static BufferedReader asReader(Object o, String defaultEncoding="UTF-8") throws IOException{
		if(o==null){
